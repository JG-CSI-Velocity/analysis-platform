...
def chart_personal_top_by_spend(result: AnalysisResult, config: ChartConfig) -> Figure:
...
def chart_personal_top_by_transactions(result: AnalysisResult, config: ChartConfig) -> Figure:
...
def chart_personal_top_by_accounts(result: AnalysisResult, config: ChartConfig) -> Figure:
