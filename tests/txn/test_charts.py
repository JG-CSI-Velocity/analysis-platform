...
class TestTrendCharts:
    ...
    def growth_result(self):
        ...
        return AnalysisResult(name="growth_leaders_decliners", title="Growth", df=df, sheet_name="M5B")
    ...
    def cohort_result(self):
        ...
        return AnalysisResult(name="new_vs_declining_merchants", title="Cohort", df=df, sheet_name="M5D")
...
class TestScorecardBullets:
    ...
    def scorecard_result(self):
        ...
        return AnalysisResult(
            name="portfolio_scorecard", title="Scorecard", df=df, sheet_name="M9"
        )
...
class TestCreateCharts:
    ...
    def test_source_footer_applied(self, spend_result, chart_config):
        ...
        charts = create_charts(
            [spend_result], chart_config,
            client_name="Test CU", date_range="2025-07 to 2025-12",
        )
    ...
    def test_empty_results_produce_no_charts(self, chart_config):
        from txn_analysis.charts import create_charts
        empty = AnalysisResult(name="top_merchants_by_spend", title="x", df=pd.DataFrame(), sheet_name="x")
